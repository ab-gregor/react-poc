...
function NavScrollExample({ searchTerm, setSearchTerm }) {
    ...
    <Navbar expand="lg" className="">
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          <div
            className="my-2 my-lg-0 me-auto2 Plist"
            style={{ maxHeight: '100px' ,marginRight:'0px'}}
            navbarScroll
          >
            <Form.Control className='searchField'
              type="text"
              placeholder="Search for a product..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
            <Nav.Item className="Logstatus"style={{ color:'white'}}>
              <b>Logged in as :</b>
            </Nav.Item>
